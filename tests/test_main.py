...
def patched_run(mock_picqer_instance):
    ...
    with (
        ...
        patch("main.LIGHTSPEED_API_KEY", "ls-key"),
        patch("main.LIGHTSPEED_API_SECRET", "ls-secret"),
...
class TestRunSyncConfigValidation:
    ...
    def test_raises_when_lightspeed_credentials_missing(self):
        with (
            ...
            patch("main.LIGHTSPEED_API_KEY", ""),
            patch("main.LIGHTSPEED_API_SECRET", ""),
        ):
            with pytest.raises(RuntimeError, match="LIGHTSPEED_API_KEY"):
                main.run_sync()
...
class TestRunSyncCounting:
    ...
    def test_updated_when_sync_returns_true(self, patched_run):
        ...
        main.run_sync()  # completes without error; updated=1
    ...
    def test_skipped_when_sync_returns_false(self, patched_run):
        ...
        main.run_sync()  # completes without error; skipped counted
    ...
    def test_request_exception_does_not_crash_run(self, patched_run):
        ...
        main.run_sync()  # must not raise; errors=1
